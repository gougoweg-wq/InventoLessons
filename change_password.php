    ...
    if (!$old_password || !$new_password || !$confirm_password) {
        ...
        if ($isTeacher) {
            ...
            if (!$stored) {
                ...
                // Teachers expected to use password_hash()
            ...
            // Students may be using legacy md5 or password_hash
            ...
            if (!$stored) {
                ...
                $verified = false;
                // Detect likely MD5 hash (32 hex chars) — migrate to password_hash on success
                if (preg_match('/^[a-f0-9]{32}$/i', $stored)) {
                    if (md5($old_password) === $stored) $verified = true;
                } else {
                    if (password_verify($old_password, $stored)) $verified = true;
                }
